...
A Product Team Operating System repository that treats product management knowledge — strategy, PRDs, analytics, processes — as a living, version-controlled codebase. Built for collaboration with AI agents (Claude Code, MCP-enabled tooling) and human teammates via GitHub.
