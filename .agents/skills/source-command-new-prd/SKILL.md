---
name: "source-command-new-prd"
description: "Create a branch and scaffold a new PRD from the lean one-pager template"
---

# source-command-new-prd

Use this skill when the user asks to run the migrated source command `new-prd`.
...
5. Invoke `.Codex/skills/ask-user-workflow.md` — interview the user.
6. Invoke `.Codex/skills/draft-prd.md` — fill the one-pager from interview answers.
7. Invoke `.Codex/skills/verify-prd.md` — self-check.
