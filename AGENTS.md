...
See `CLAUDE.md` for the canonical version. See `agents/` for the 11 agent definitions and `governance/framework.md` for the constitution. See `.claude/agents/ROSTER.md` for the YUUP runnable subagents.
...
## YUUP Orchestrator
Launch with `/yuup "<objective>"`. Runs autonomously, dispatches runnable subagents from `.claude/agents/`. See `.claude/agents/ROSTER.md`.
